...
/**
 * SpamCheckPut Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SpamCheckPut implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'spamCheckPut';
     ...
     * Sets content
     *
     * @param string $content the text content of the email. this or htcontent must be set
     *
     * @return $this
     */
     ...
     * Sets htcontent
     *
     * @param string $htcontent the html content of the email. Empty for textmail
     *
     * @return $this
     */
     ...
     * Sets sendername
     *
     * @param string $sendername sendername of the email
     *
     * @return $this
     */
     ...
     * Sets senderemail
     *
     * @param string $senderemail senderemail of the email
     *
     * @return $this
     */
