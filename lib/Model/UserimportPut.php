...
class UserimportPut implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['unqiue_field'] = isset($data['unqiue_field']) ? $data['unqiue_field'] : null;
     ...
     * @return string
     */
    public function getUnqiueField()
    {
        return $this->container['unqiue_field'];
    }

    /**
     * Sets unqiue_field
     *
     * @param string $unqiue_field unique field which is taken for update, delete, insert. standard is email
     *
     * @return $this
     */
    public function setUnqiueField($unqiue_field)
    {
        $this->container['unqiue_field'] = $unqiue_field;
